...
#Ex43_BasicObjOrientedAnalysisDesign.py
...
#	* Central Corridor: This is the starting point and has a Gothon already standing there they have to defeat with a joke before continuing.
...
#Top Down approach: create generic functions and define them as go along functionality.
#* Map
#  - next_scene
#  - opening_scene
#* Engine
...
class Scene (object):
     def enter (self):
          print "This scene is not yet configured. Subclass it and implemenet enter()."
          exit(1)
